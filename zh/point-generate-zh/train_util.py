...
def evaluate(args,model,save_dir,update_step):
...
def train(args,model,optimizer,with_eval):
            ...
            for i,batch in enumerate(data_iterator):
                ...
                if 0 == (forward_step % args.gradient_accumulation_steps):
                    ...
                    if 1 == update_step or 0 == update_step % args.evaluation_steps:
                        ...
                        if with_eval:
                            evaluate(args=args,model=model,save_dir=save_dir,update_step=update_step)
